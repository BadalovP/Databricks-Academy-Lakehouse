...
The September 18 deployment successfully applied the GP2/classic-compute configuration. Final bundle validation reported zero changes. The production job has not yet been executed using the new compute configuration.
