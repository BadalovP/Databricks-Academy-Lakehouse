...
The Lab 07 implementation spans both the lab-specific project folder and the shared Databricks Asset Bundle resources at the repository root.
...
│       ├── evidence/
│       │   ├── pytest/
│       │   │   └── generated_static_validation.txt
│       │   └── screenshots/
│       │       └── 14 successful validation images (01-14)
│       │
│       ├── notebooks/
...
│       │
│       ├── src/
│       │   ├── lab07/                       # reusable Lab 07 Python package
│       │   └── tests/
...
│       │   ├── fixtures/
│       │   ├── integration/
│       │   │   └── test_deployed_medallion_e2e.py
│       │   ├── quality/
│       │   └── unit/
│       │
│       └── tools/
...
`databricks.yml` provides shared bundle variables and target overrides, while `resources/lab07_*.yml` defines the deployable Lab 07 infrastructure, pipeline, monitoring, dashboard, and orchestration job.
