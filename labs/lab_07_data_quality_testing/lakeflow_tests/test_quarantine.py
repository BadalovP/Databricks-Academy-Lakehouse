...
def test_business_license_quarantine(test_spark):
    ...
    test_pipeline.run(test_spark, set(["dbr_dev.parvinbadalov.business_license_quarantine"]))
    assert test_spark.table("dbr_dev.parvinbadalov.business_license_quarantine") is not None
